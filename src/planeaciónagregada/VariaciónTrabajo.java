...
public class VariaciónTrabajo {
    ...
    public int getCostoDespido() {
        return CostoDespido;
    }

    public void setCostoDespido(int CostoDespido) {
        this.CostoDespido = CostoDespido;
    }
